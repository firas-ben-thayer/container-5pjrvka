...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-5pjrvka.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-5pjrvka.containers.anotherwebservice.com/
...
```
git clone git@github.com:firas-ben-thayer/container-5pjrvka.git
cd container-5pjrvka
```
...
```
docker attach container-5pjrvka
```
